...
interface AuthRemoteDataSource {
    suspend fun signIn(email: String, password: String, rememberMe: Boolean = false): Result<User, AuthError>
    suspend fun signUp(name: String, email: String, password: String, rememberMe: Boolean = false): Result<User, AuthError>
